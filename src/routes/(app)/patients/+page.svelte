    ...
    <header class="border-b pb-4">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-muted-foreground">A list of all patients in the clinic</p>
            </div>
            <Button onclick={() => goto('/patients/new')}>
                <svg
                    ...
                    <Table.Root>
                        <Table.Header>
                            <Table.Row>
                                ...
                                <Table.Head>Insurance ID</Table.Head>
                        ...
                        <Table.Body>
                            {#each filteredPatients as patient}
                                <Table.Row>
                                    <Table.Cell class="font-medium">{patient.full_name}</Table.Cell>
                                    <Table.Cell>{patient.insurance_id}</Table.Cell>
